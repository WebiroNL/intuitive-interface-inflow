  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        webiro: {
          blue: "hsl(var(--webiro-blue))",
          "blue-dark": "hsl(var(--webiro-blue-dark))",
          purple: "hsl(var(--webiro-purple))",
          yellow: "hsl(var(--webiro-yellow))",
          dark: "hsl(var(--webiro-dark))",
          light: "hsl(var(--webiro-light))",
          "light-blue": "hsl(var(--webiro-light-blue))",
