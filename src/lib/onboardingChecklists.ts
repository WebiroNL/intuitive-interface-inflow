...
export const ONBOARDING_SERVICES: OnboardingService[] = [
  ...
  // ===== WEBSITE / WEBSHOP =====
  {
    ...
    fields: [
      ...
      { key: "legal_docs_url", label: "Link naar juridische documenten (KVK, BTW, AV)", type: "multilink", placeholder: "Google Drive, WeTransfer, Dropbox, OneDrive, iCloud, Box of Mega...", help: "Optioneel — handig voor facturatie en eventuele integraties." },
    ],
  },
  {
    id: "webshop",
...
export const COMMON_ASSET_FIELDS: OnboardingField[] = [
  { key: "logo_url", label: "Link naar logo", type: "multilink", placeholder: "Google Drive, WeTransfer, Dropbox, OneDrive, iCloud, Box of Mega...", help: "Deel één of meerdere links (Drive, Dropbox, WeTransfer) naar je logo bestanden — bij voorkeur in vector (SVG/AI/EPS) én PNG." },
  { key: "content_url", label: "Link naar content (teksten & beeld)", type: "multilink", placeholder: "Google Drive, WeTransfer, Dropbox, OneDrive, iCloud, Box of Mega...", help: "Deel één of meerdere links naar teksten, foto's en eventuele video's." },
  { key: "brand_book_url", label: "Link naar brand book / huisstijl", type: "multilink", placeholder: "Google Drive, WeTransfer, Dropbox, OneDrive, iCloud, Box of Mega...", help: "Optioneel — voeg meerdere links toe als je huisstijldocumenten op verschillende plekken staan." },
