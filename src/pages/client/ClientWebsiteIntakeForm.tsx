            ...
            {sections.find((s) => s.id === "bedrijf") && (
              <WSec id="bedrijf" sectionKey="wsec.bedrijf" number={numberMap.get("bedrijf")!} defaultTitle="Bedrijf & Contact" icon={WEBSITE_INTAKE_SECTIONS[0].icon}>
                <Grid2>
                  ...
                  <WField labelId="wf.huidige_website" label="Huidige website"><Input placeholder="https://drive.google.com/... of https://wetransfer.com/..." value={data.huidige_website ?? ""} onChange={(e) => set("huidige_website", e.target.value)} /></WField>
