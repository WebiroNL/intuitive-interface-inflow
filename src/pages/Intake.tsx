...
import { Calendar01Icon, Clock01Icon, CheckmarkCircle02Icon, ArrowLeft01Icon } from "@hugeicons/core-free-icons";
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12 max-w-6xl mx-auto">
              <div className="bg-card p-6 rounded-2xl shadow-md transition-colors border border-border">
                <div className="bg-primary w-12 h-12 rounded-xl flex items-center justify-center mb-4">
                  <HugeiconsIcon icon={Clock01Icon} size={24} className="text-primary-foreground" />
                </div>
              ...
              <div className="bg-card p-6 rounded-2xl shadow-md transition-colors border border-border">
                <div className="bg-primary w-12 h-12 rounded-xl flex items-center justify-center mb-4">
                  <HugeiconsIcon icon={CheckmarkCircle02Icon} size={24} className="text-primary-foreground" />
                </div>
              ...
              <div className="bg-card p-6 rounded-2xl shadow-md transition-colors border border-border">
                <div className="bg-primary w-12 h-12 rounded-xl flex items-center justify-center mb-4">
                  <HugeiconsIcon icon={Calendar01Icon} size={24} className="text-primary-foreground" />
                </div>
