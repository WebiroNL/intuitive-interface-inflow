                ...
                <svg width="18" height="18" viewBox="0 0 251 192" fill="none" className="overflow-visible">
                  <path
                    ...
                    style={{
                      ...
                      animation: 'webiroWDraw 2.5s ease-in-out infinite',
                    }}
                  />
                </svg>
              </div>
