...
const reviews = [
  ...
  { name: "Christina N.", role: "CKN Legal", text: "Professionele website die perfect aansluit bij mijn juridische diensten. De samenwerking verliep uitstekend.", initials: "CN", color: "from-pink-500 to-rose-600", photo: cknPhoto },
